...
export * as ListingsAPI from "./types/listings-api/v2021-08-01";
export * as OrdersAPI from "./types/orders-api/v0";
export * as ReportsAPI from "./types/reports-api/v2021-06-30";
export * as ShippingAPI from "./types/shipping-api/v1";